  ...
  const handleNewProduct = async () => {
    await axios
      .post('http://localhost:6001/add-new-product', {
        ...
        productPrice,
        productDiscount,
        isFlashSale, // Include isFlashSale in the POST request
      })
      .then((response) => {
        alert('Product added');
        ...
        setIsFlashSale(false); // Reset the flash sale state
        ...
        <div className="new-product-body">
          ...
          <span>
            <div className="form-floating mb-3 span-3">
              ...
              <label htmlFor="floatingNewProduct5">Product Category</label>
            </div>
            ...
            <div className="form-floating mb-3 span-3">
              ...
              />
              <label htmlFor="floatingNewProduct6">Product New Category</label>
            </div>
          </span>
          ...
          <div className="form-floating mb-3 span-3">
            ...
            />
            <label htmlFor="floatingNewProduct7">Product Price</label>
          </div>
          ...
          <div className="form-floating mb-3 span-3">
            ...
            />
            <label htmlFor="floatingNewProduct8">Product Discount</label>
          </div>
          ...
          <div className="form-check mb-3">
            <input
              className="form-check-input"
              type="checkbox"
              id="flexCheckFlashSale"
              checked={isFlashSale}
              onChange={(e) => {setIsFlashSale(e.target.checked);
              console.log("Flash Sale Checkbox State:", e.target.checked);
              }}
            />
            <label className="form-check-label" htmlFor="flexCheckFlashSale">
              Flash Sale
            </label>
          </div>

          <button className="btn btn-dark" onClick={handleNewProduct}>
            Add Product
          </button>
        </div>
      </div>
